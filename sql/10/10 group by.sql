...
SELECT SUM(verkoopprijs) FROM `verkochtproduct` WHERE product = "mario wonder" GROUP BY product;

SELECT *, SUM(aantal) FROM `verkochtproduct` WHERE product = "mario wonder" GROUP BY product;